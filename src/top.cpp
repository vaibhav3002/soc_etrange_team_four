...
int _main(int argc, char *argv[])
{
   ...
   // interconnection signals
    ...
    soclib::caba::VideoGen  videogen("myvideo_in");     
    ...
    soclib::caba::Master<wb_param>    master_module  ("master");
   ...
   //dummy write instanciation
     soclib::caba::Master_dummy_write <wb_param>    master_dummy_write  ("master_dummy");
