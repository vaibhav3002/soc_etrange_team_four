 ...
 * =============================================================================
 *
 *       Filename:  wb_master_module_tuille.h
 *
 *    Description:  generic wb module (reads and writes tiles)
 *
 *         Author:  Tarik Graba (TG), tarik.graba@telecom-paristech.fr
 	 Modified:  Ted theodoro@telecom-paristech.fr
 *        Company:  Telecom Paris TECH
 *
 * =============================================================================
 */

#ifndef _WB_MASTER_MODULE_TUILLE_
#define _WB_MASTER_MODULE_TUILLE_
#define IMAGE_X_DIMENSION ((uint32_t) 640)
...
namespace soclib { namespace caba {
        ...
        class WbMasterModuleTuille
    {
        public:
            ...
            // constructor
            WbMasterModuleTuille ( sc_core::sc_in<bool> &p_clk,
                    soclib::caba::WbMaster<wb_param> &p_wb
                    );

            friend std::ostream& operator<< (std::ostream &o, WbMasterModuleTuille &wbm)
            {
                wbm._print(o);
                return o;
            }
